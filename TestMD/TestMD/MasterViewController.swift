...
//        navigationItem.rightBarButtonItem = addButton
        listArray = ["Asking Alexandria", "A Day to Remember", "Bullet for My Valentine", "Good Charlotte", "Hollywood Undead", "I Prevail", "Linkin Park", "Saosin", "Senses Fail", "Three Days Grace"]
